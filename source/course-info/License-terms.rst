...
We remixed resources from last `year's course <https://kodu.ut.ee/~kmoch/geopython2018/>`_ and materials from Henrikki Tenkanen's GeoPython course from the University of Helsinki, under CC-BY-SA from `from GitHub <https://github.com/Automating-GIS-processes/2017>`_.
...
Except where otherwise noted, the example programs, code snippets and other software provided by the Geospatial Analysis with Python -course are made
available under the **MIT license** (read licence `here <https://spdx.org/licenses/MIT.html>`_.
